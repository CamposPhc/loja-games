...
import com.LojadeGames.LojaDeGames.Controller.Service.UsuarioService;
...
public class UsuarioController {
	...
	@GetMapping("/all")
	public ResponseEntity<List<UsuarioLogin>> getAll() {
	...
	@GetMapping("/{id}")
	public ResponseEntity<UsuarioLogin> getById(@PathVariable Long id) {
